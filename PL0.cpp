...
int main()
{
	...
	printf("        |  班别：人工智能2班                                             |\n");
	printf("        |  姓名：张皓                                                    |\n");
	printf("        |  学号：3121005409                                              |\n");
	printf("        |  开始调试代码时间：06/02                                       |\n");
	printf("        |  完成调试代码时间：06/21                                       |\n");
    printf("        |                                                                |\n");
	printf("        ==================================================================\n");
	printf("\n请输入PL/0文件路径>>");
	scanf("%s",fname);                                     /*输入文件名*/
	...
	if(fin)
	{
		...
		if(-1!=getsym())
		{
			...
			if(err==0)
			{
				time_t timep; 
                struct tm *p;
				char *wday[]={const_cast<char*>("Sun"),const_cast<char*>("Mon"),const_cast<char*>("Tue"),const_cast<char*>("Wed"),const_cast<char*>("Thu"),const_cast<char*>("Fri"),const_cast<char*>("Sat")};
				fa2=fopen("fa2.tmp","w");			                  
                time(&timep); 
                p=gmtime(&timep); 
